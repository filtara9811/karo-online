...
/* -------------------- My Orders List (inline under Orders card) -------------------- */
type OrderSource = "quick" | "service" | "shop" | "lead";
type OrderStatusKind = "pending" | "active" | "completed";
